...
export default function Sidebar() {
  return (
    <div className="sidebar">
          ...
          <ul class="space-y-4 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">DM's</span>
      ...
      {/* <button
        type="button"
        class="text-gray-900 bg-gray-300 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2 ml-32 mt-4"
      >
        Logout
      </button> */}
    </div>
